...
export default function Sidebar() {
    return(
        <div>
            ...
            <aside id="logo-sidebar" className="fixed  font-mono top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
