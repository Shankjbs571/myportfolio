...
export default function Theme() {
    ...
    return (
        <div className="flex flex-row mt-3 absolute top-3 right-10">
            <button data-modal-target="default-modal" data-modal-toggle="default-modal" className="block focus:outline-none font-medium transition duration-700 rounded-lg text-sm px-5 py-2.5 text-center " type="button">
